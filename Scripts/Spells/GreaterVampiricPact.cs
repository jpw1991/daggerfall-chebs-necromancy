...
{
    public class GreaterVampiricPact
    {
        public static EffectBundleSettings Create()
        {
            var effectKey = SummonAncientVampireEffect.EffectKey;
            ...
            {
                ChebsNecromancyMod.ChebsNecromancy.ChebError("GreaterVampiricPact.Create: Failed to get template from effect broker");
            ...
            {
                Key = "GreaterVampiricPact-CustomOffer",
