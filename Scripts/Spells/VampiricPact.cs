...
{
    public class VampiricPact
    {
        public static EffectBundleSettings Create()
        {
            var effectKey = SummonVampireEffect.EffectKey;
            ...
            {
                ChebsNecromancyMod.ChebsNecromancy.ChebError("VampiricPact.Create: Failed to get template from effect broker");
