...
{
    public class RoilSpirit
    {
        public static EffectBundleSettings Create()
        {
            var effectKey = SummonGhostEffect.EffectKey;
            ...
            {
                ChebsNecromancyMod.ChebsNecromancy.ChebError("RoilSpirit.Create: Failed to get template from effect broker");
