...
{
    public class CallGreaterAscendedMinion
    {
        public static EffectBundleSettings Create()
        {
            var effectKey = SummonAncientLichEffect.EffectKey;
            ...
            {
                ChebsNecromancyMod.ChebsNecromancy.ChebError("CallGreaterAscendedMinion.Create: Failed to get template from effect broker");
            ...
            var animateDead = new EffectBundleSettings()
            {
                ...
                Name = "Call Greater Ascended Minion",
                IconIndex = 12,
            ...
            {
                Key = "CallGreaterAscendedMinion-CustomOffer",
